<?php
  $conn = new mysqli('localhost', 'root', '', 'DatabaseTrangSucCuoi');
    ...
    function get_product_by_id($connect, $type_pro){
      $sql = "SELECT * FROM Products WHERE id = '".$type_pro."'";
        ...
        <div class="row">
          ...
          <div class="col-md-10 col-sm-10">
            <div class="box-index">
              ...
              <div class="row">
                <?php
                  $sql = "SELECT count(*) FROM Products WHERE type_pro = 'Nhẫn vàng'";
                  ...
                  for ($i=1; $i <= $total ; $i++) { 
                    ...
                    echo"
                    <div class='col-lg-3 col-md-3 images' style='margin-top: 5px;''>
